const escreve = document.getElementById("horaDia")
  ...
  if (hora >= 0 && hora < 6) {
    ...
    section.innerHTML= `<p class="msg">Boa madrugada, agora são ${horapm}:${min} e ${sec} segundos.</p><br><img src="midia/images/madrugada.png" class="imgmadrugada">`
  }else if (hora < 12) {
    ...
    section.innerHTML= `<p class="msg">Boa tarde, agora são ${horapm}:${min} e ${sec} segundos.</p><br><img src="midia/images/tarde.png" class="imgtarde">`
  }else if (hora <= 23) {
    body.style.background = '#1F1F20'
    body.style.color = 'white'
    escreve.innerHTML = '<h1>Hora da Noite</h1>'
    section.innerHTML= `<p class="msg">Boa noite, agora são ${horapm}:${min} e ${sec} segundos.</p><br><img src="midia/images/noite.png" class="imgnoite">`
  }else {
